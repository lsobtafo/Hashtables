...
public class Hashtable {
    ...
    public Object get(Object key) {
          ...
          //finding linked list at index pos

          LinkedList<HashtableRecord> list = (LinkedList<HashtableRecord>) this.table[pos];

          //looping through each record in the list

          for (HashtableRecord record : list) {

                //comparing key of current record with given key

                if (record.key.equals(key)) {

                      // found, returning the value
